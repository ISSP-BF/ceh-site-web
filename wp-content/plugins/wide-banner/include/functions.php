            ...
            //add link?
             if(((!empty(sanitize_text_field($_POST['wb_btn_text']))) && (!empty($_POST['btn_link']))) || (sanitize_text_field($_POST['add_btn']) == 'full')
                ...
                $db_table_prefix = $wpdb->prefix;
                  ...
                  $add_wb = $wpdb->prepare("INSERT into ".$db_table_prefix."wb_banner (texte,bg_color,txt_color,type_btn,btn,btn_bg_color,btn_txt_color,link,date_end) VALUES (
